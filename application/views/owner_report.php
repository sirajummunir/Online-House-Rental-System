                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbars-rs-food">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/pending_post">PENDING POST</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/renter_report">RENTER REPORT</a></li>
                            <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(); ?>welcome/owner_report">OWNER REPORT</a></li>
                        ...
                        <tbody>
                            ...
                            foreach ($owner_report as $index => $value) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $owner_report2[$index]->first_name; ?> <?php echo $owner_report2[$index]->last_name; ?></td>
                                    ...
                                    if ($value->block_account == 1) {
                                        ?>
                                        <td><a class="btn btn-common" style="padding:4px;" href="<?php echo base_url(); ?>welcome/unblock_owner/<?php echo $value->owner_id; ?>" onclick="return confirm('Are you sure? you want to Unblock this Owner.')">Unblock</a></td>
                                        <?php
                                    } else {
                                        ?>
                                        <td><a class="btn btn-danger" style="padding:4px;" href="<?php echo base_url(); ?>welcome/block_owner/<?php echo $value->owner_id; ?>" onclick="return confirm('Are you sure? You want to Block this Owner.')">Block</a></td>
                                        <?php
                                    }
                                    ?>
                                </tr>
