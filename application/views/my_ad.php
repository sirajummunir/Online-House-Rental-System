                    ...
                    <div class="collapse navbar-collapse" id="navbars-rs-food">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <?php
                                        ...
                                        ?>
                            <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(); ?>welcome/my_ad">MY ADS</a></li>
                                    ...
                                    if ($value->owner_id == $this->session->userdata('owner_id')) {
                                        ...
                                        <div class="carousel-item text-center active">
                                            <div class="p-1 border rounded-circle m-auto" style="width: 150px">
                                                <img class="d-block w-100 rounded-circle" src="<?php echo base_url(); ?><?php echo $value->image; ?>" alt="">
                                            </div>
                                            <h4 class="mt-4 mb-0"><strong class="text-warning text-uppercase"><?php echo $value->title; ?></strong></h4>
                                            ...
                                            <h5 style="margin-bottom: 50px; font-weight: bold"><?php if($value->active==0)echo 'Succesfully Rented' ?></h5>
                                        </div>
                                        <?php 
                                    }
                                }
